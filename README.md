...
> * 注意，盈米开放接口需要使用TLSv1.1或者TLSv1.2协议。所以**建议使用JDK1.7以上版本开发SDK**。对于JDK6，其老版本只支持SSLv3.0等具有巨大安全风险的SSL协议，本系统不支持。如果必须使用JDK6，请升级到JDK6u121. 该版本支持了TLSv1.2。本例子假设使用JDK1.7。
